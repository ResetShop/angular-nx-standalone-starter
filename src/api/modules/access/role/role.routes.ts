...
export const listRolesRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_ROLES_READ)] as const,
...
export const createRoleRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_ROLES_CREATE)] as const,
	request: {
		body: {
...
export const updateRoleRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_ROLES_UPDATE)] as const,
	request: {
...
export const deleteRoleRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_ROLES_DELETE)] as const,
	request: { params: idParamSchema },
	responses: {
		200: {
