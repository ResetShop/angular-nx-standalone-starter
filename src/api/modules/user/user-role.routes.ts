...
export const getUserRolesRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_USER_ROLES_READ)] as const,
	request: {
...
export const assignRoleRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_USER_ROLES_ASSIGN)] as const,
	request: {
		params: userIdParamSchema,
		body: {
...
export const replaceUserRolesRoute = createRoute({
	...
	middleware: [
		requireAllPermissions([Permission.ADMIN_USER_ROLES_ASSIGN, Permission.ADMIN_USER_ROLES_REMOVE]),
	] as const,
	request: {
		params: userIdParamSchema,
		body: {
...
export const removeRoleRoute = createRoute({
	...
	middleware: [requirePermission(Permission.ADMIN_USER_ROLES_REMOVE)] as const,
