...
@Component({
	...
	template: `
		<div
			class="bg-card text-card-foreground sm:border-border flex h-full flex-col items-center justify-center gap-4 p-4 sm:rounded-xl sm:border sm:shadow-2xs md:p-5"
		>
